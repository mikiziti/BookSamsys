...
public class AuthorService : IAuthorService
{
    ...
    public async Task<MessagingHelper> CreateAuthor(CreateAuthorDTO createAuthorDto)
    {
    ...
    public async Task<MessagingHelper> UpdateAuthor(Guid id, UpdateAuthorDTO updateAuthorDto)
    {
        MessagingHelper res = new();
        try
        {
